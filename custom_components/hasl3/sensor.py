...
class HASLRouteSensor(HASLDevice):
    ...
    def extra_state_attributes(self):
        ...
        try:
            ...
            val['first_line'] = self._sensordata["first_line"]
            val['first_direction'] = self._sensordata["first_direction"]
            val['first_category'] = self._sensordata["first_category"]
            val['first_time'] = self._sensordata["first_time"]
            val['first_from'] = self._sensordata["first_from"]
            val['first_to'] = self._sensordata["first_to"]
            val['last_leg'] = self._sensordata["last_leg"]
            val['last_line'] = self._sensordata["last_line"]
            val['last_direction'] = self._sensordata["last_direction"]
            val['last_category'] = self._sensordata["last_category"]
            val['last_time'] = self._sensordata["last_time"]
            val['last_from'] = self._sensordata["last_from"]
            val['last_to'] = self._sensordata["last_to"]
