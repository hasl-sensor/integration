...
CONF_INTEGRATION_LIST = [SENSOR_RRDEP, SENSOR_RRARR, SENSOR_RRROUTE, SENSOR_STANDARD, SENSOR_STATUS, SENSOR_VEHICLE_LOCATION, SENSOR_DEVIATION, SENSOR_ROUTE]
