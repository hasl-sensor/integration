...
def deviation_config_option_schema(options: dict = {}) -> dict:
    ...
    if not options:
        options = {CONF_SCAN_INTERVAL: DEFAULT_SCAN_INTERVAL, CONF_SENSOR: "", CONF_SI2_KEY: "", CONF_DEVIATION_STOPS: "", CONF_DEVIATION_LINES: "", CONF_DEBUG: False}
    return {
...
def status_config_option_schema(options: dict = {}) -> dict:
    ...
    if not options:
        options = {CONF_SCAN_INTERVAL: DEFAULT_SCAN_INTERVAL, CONF_SENSOR: "", CONF_TL2_KEY: "", CONF_DEBUG: False, CONF_ANALOG_SENSORS: False}
    return {
...
def vehiclelocation_config_option_schema(options: dict = {}) -> dict:
    ...
    if not options:
        options = {CONF_SCAN_INTERVAL: DEFAULT_SCAN_INTERVAL, CONF_SENSOR: "", CONF_FP_PT: False, CONF_FP_RB: False, CONF_FP_TVB: False, CONF_FP_SB: False, CONF_FP_LB: False, CONF_FP_SPVC: False, CONF_FP_TB1: False, CONF_FP_TB2: False, CONF_FP_TB3: False, CONF_DEBUG: False}
    return {
